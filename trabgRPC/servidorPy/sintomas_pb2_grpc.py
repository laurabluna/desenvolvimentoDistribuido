...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in sintomas_pb2_grpc.py depends on'
...
class SintomasServiceStub(object):
...
class SintomasServiceServicer(object):
    """Missing associated documentation comment in .proto file."""
...
def add_SintomasServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
